...
var (
	...
	ContextLength = Uint("OLLAMA_CONTEXT_LENGTH", 8192)
	// ContextExpandLength sets the default context expansion length
	ContextExpandLength = Uint("OLLAMA_CONTEXT_EXPAND_LENGTH", 8192)
)
